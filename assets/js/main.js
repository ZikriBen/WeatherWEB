$(document).ready(function () {
    ...
    // GET CURRENT POSTION (MAYBE INACCURATE, BASED ON ISP INFORMATION)
    ...
    if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(function (position) {
            ...
            var api = 'http://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + long + '&appid=33d6b377a937558c2a27f0be8b477457&units=metric';
    
            // GATHER INFORMATION FROM OPENWEATHERMAP JSON
